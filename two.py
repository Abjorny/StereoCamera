...
if __name__ == '__main__':
    ...
    variable_mapping = {"SWS": 15,              # Размер окна сравнения (5–51, нечётное)
"SpeckleSize": 100,     # Удаление шума (50–200)
"SpeckleRange": 2,      # Диапазон пятнистостей (1–10)
"UniqRatio": 10,        # Уникальность совпадения (5–15)
"TxtrThrshld": 15,      # Порог текстуры (10–20)
"NumofDisp": 96,        # Кол-во диспаратностей (64, 96, 128) кратно 16
"MinDisp": 0,           # Мин. диспаратность
"PreFiltCap": 31,       # Фильтрация (10–40)
"PreFiltSize": 9        # Размер фильтра (5–63, нечётное)
}
